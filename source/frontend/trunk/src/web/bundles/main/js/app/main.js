...
App.menuController = App.MenuController.create({
	content: [
			...
			subMenu: [
				App.MenuItem.create({
					...
					subMenu: [
						...
						App.MenuItem.create({
							id: 6,
							roles: [['ROLE_LABOR_PARLAMENTARIA'], ['ROLE_DIPUTADO']],
							titulo: 'Sesiones',
							url: '#/novedades/6',
						}),			
						App.MenuItem.create({
				...
				App.MenuItem.create({
					...
					subMenu: [
						...
						App.MenuItem.create({
							...
							roles: [['ROLE_INFORMACION_PARLAMENTARIA','ROLE_IP_EDITOR'], ['ROLE_DIPUTADO'], ['ROLE_INFORMACION_PARLAMENTARIA_EDIT']],
						}),
					],
				}),
			]			
		...
		App.MenuItem.create({
			id: 11,
			roles: [['ROLE_VISITAS_GUIADAS'], ['ROLE_DIPUTADO']],
