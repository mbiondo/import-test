				...
				App.MenuItem.create({
					...
					subMenu: [
						App.MenuItem.create({
							...
							roles: [['ROLE_INFORMACION_PARLAMENTARIA','ROLE_IP_EDITOR'], ['ROLE_INFORMACION_PARLAMENTARIA','ROLE_IP_DEPARTAMENTO'], ['ROLE_INFORMACION_PARLAMENTARIA_EDIT'], ['ROLE_INFORMACION_PARLAMENTARIA', 'ROLE_IP_DEPARTAMENTO_EDIT'], ['ROLE_IP_DEPARTAMENTO_EDIT'], ['ROLE_INFORMACION_PARLAMENTARIA_EDIT']], 
						}),
						App.MenuItem.create({
							id: 1,
